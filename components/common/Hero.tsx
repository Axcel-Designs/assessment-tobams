...
export default function Hero() {
  return (
    <section
      className="relative bg-fixed bg-[url('../assets/banner.png')] bg-cover bg-no-repeat bg-center w-full m-auto bg-gray-500 text-white flex items-center justify-center h-127.75 max-md:h-[317px]"
    >
